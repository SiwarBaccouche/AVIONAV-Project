...
class _EditClientState extends State<EditClient> {
  TextEditingController _nameController, _numberController, _EmailController = TextEditingController();
  ...
  getContactDetail() async {
    DatabaseEvent snapshot = await _ref.child(widget.clientKey).once();

    Map client = snapshot.snapshot.value;

    _nameController.text = client['Full Name'];

    _numberController.text = client['Phone'];

    _EmailController.text = client['Email'];

    setState(() {
      _typeSelected = client['Privilege'];
    });
  }
  ...
  void saveClient() {
    ...
    String Email = _numberController.text;
    ...
    _ref.child(widget.clientKey).update(client).then((value) {
