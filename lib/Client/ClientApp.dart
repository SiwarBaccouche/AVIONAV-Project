...
import 'package:avionav/Client/CircleProgress.dart';
...
class ClientApp extends StatefulWidget {
  ...
  ClientApp({Key key, this.currentUser}) : super(key: key);
      ...
      child: Scaffold(
        body: SafeArea(
          child: IndexedStack(
            index: currentIndex,
            children: [
              MapPage(cu: widget.currentUser),
              Dashboard(cu: widget.currentUser),
              Remote(cu: widget.currentUser),
