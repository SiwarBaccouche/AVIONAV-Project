...
class _DashboardState extends State<Dashboard>
  ...
  final CircleProgress te = new CircleProgress(0, false);
  final CircleProgress hu = new CircleProgress(0, false);
  final TextEditingController temCont = new TextEditingController();
  final TextEditingController humCont = new TextEditingController();
  final TextEditingController doorCont = new TextEditingController();
  ...
  Widget build(BuildContext context) {
    setState(() {
      DatabaseReference ref1 =
          FirebaseDatabase.instance.ref('/Airplane/gps/Temp');
      DatabaseReference ref2 =
          FirebaseDatabase.instance.ref('/Airplane/gps/Humid');
      DatabaseReference ref3 =
          FirebaseDatabase.instance.ref('/Airplane/gps/Door State');
                      ...
                      LiteRollingSwitch(
                        ...
                        onChanged: (bool state) async {
                          DatabaseReference ref = FirebaseDatabase.instance
                              .ref("Airplane/gps/Door");

                          await ref.update({
                            "Airplane/gps/Door": state ? 'ON' : 'OFF',
                          });
